  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <?php
    // Cek diskon hari ini (dikirim dari controller via $discount, atau dari shared data)
    $discountInfo = isset($discount) ? $discount : null;
    if ($discountInfo) :
    ?>
    <div class="ms-3 me-auto">
        <span class="badge bg-success fs-6 px-3 py-2">
            Hari ini ada diskon IDR <?= number_format($discountInfo['nominal'], 0, ',', '.') ?> per item
        </span>
    </div>
    <?php endif; ?>
